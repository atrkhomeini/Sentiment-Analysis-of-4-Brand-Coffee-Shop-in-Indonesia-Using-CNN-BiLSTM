...
# Load dataset
df = pd.read_csv('../../data/output/kopken_normalized.csv')
...
target_brands = ['kopi kenangan', 'kopken']
...
for _, row in df.iterrows():
    ...
    if target_brands in text.lower() and not is_brand_only(text):
...
df_expanded.to_excel(f'{path_save}/kopken_elimination.xlsx', index=False)
print('Elimination data saved to ../data/output/kopken_elimination.csv')
